...
inline const char *EnumNameINSTANCE_LOOP_FLAG(INSTANCE_LOOP_FLAG e) {
  if (e < INSTANCE_LOOP_FLAG_INFINITY || e > INSTANCE_LOOP_FLAG_INDEPENDENT) return "";
...
inline const char *EnumNameUSER_DATA_FLAG(USER_DATA_FLAG e) {
  if (e < USER_DATA_FLAG_INTEGER || e > USER_DATA_FLAG_STRING) return "";
...
struct EffectNodeT : public flatbuffers::NativeTable {
  ...
  EffectNodeType type;
  int16_t cellIndex;
  EffectRenderBlendType blendType;
  int16_t numBehavior;
  ...
  EffectNodeT()
      : arrayIndex(0),
        ...
        cellIndex(0),
        blendType(EffectRenderBlendType_Mix),
        numBehavior(0) {
  }
};
...
struct EffectNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  EffectRenderBlendType blendType() const {
    return static_cast<EffectRenderBlendType>(GetField<int8_t>(VT_BLENDTYPE, 0));
  }
...
struct EffectNodeBuilder {
  ...
  void add_blendType(EffectRenderBlendType blendType) {
...
inline flatbuffers::Offset<EffectNode> CreateEffectNode(
    ...
    int16_t cellIndex = 0,
    EffectRenderBlendType blendType = EffectRenderBlendType_Mix,
...
struct userDataItemT : public flatbuffers::NativeTable {
  ...
  USER_DATA_FLAG flags;
  int16_t arrayIndex;
  std::vector<userDataValueUnion> data;
  userDataItemT()
      : flags(static_cast<USER_DATA_FLAG>(0)),
        arrayIndex(0) {
  }
};
...
struct userDataItem FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  USER_DATA_FLAG flags() const {
    return static_cast<USER_DATA_FLAG>(GetField<int8_t>(VT_FLAGS, 0));
  }
  int16_t arrayIndex() const {
    return GetField<int16_t>(VT_ARRAYINDEX, 0);
  }
...
struct userDataItemBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_flags(USER_DATA_FLAG flags) {
...
inline flatbuffers::Offset<userDataItem> CreateuserDataItem(
    flatbuffers::FlatBufferBuilder &_fbb,
    USER_DATA_FLAG flags = static_cast<USER_DATA_FLAG>(0),
    int16_t arrayIndex = 0,

...
inline const char *EnumNamePART_FLAG(PART_FLAG e) {
    switch (e) {
        case PART_FLAG_INVISIBLE:
            return "INVISIBLE";
        case PART_FLAG_FLIP_H:
            return "FLIP_H";
        case PART_FLAG_FLIP_V:
            return "FLIP_V";
        case PART_FLAG_CELL_INDEX:
            return "CELL_INDEX";
        case PART_FLAG_POSITION_X:
            return "POSITION_X";
        case PART_FLAG_POSITION_Y:
            return "POSITION_Y";
        case PART_FLAG_POSITION_Z:
            return "POSITION_Z";
        case PART_FLAG_PIVOT_X:
            return "PIVOT_X";
        case PART_FLAG_PIVOT_Y:
            return "PIVOT_Y";
        case PART_FLAG_ROTATIONX:
            return "ROTATIONX";
        case PART_FLAG_ROTATIONY:
            return "ROTATIONY";
        case PART_FLAG_ROTATIONZ:
            return "ROTATIONZ";
        case PART_FLAG_SCALE_X:
            return "SCALE_X";
        case PART_FLAG_SCALE_Y:
            return "SCALE_Y";
        case PART_FLAG_LOCALSCALE_X:
            return "LOCALSCALE_X";
        case PART_FLAG_LOCALSCALE_Y:
            return "LOCALSCALE_Y";
        case PART_FLAG_OPACITY:
            return "OPACITY";
        case PART_FLAG_LOCALOPACITY:
            return "LOCALOPACITY";
        case PART_FLAG_PARTS_COLOR:
            return "PARTS_COLOR";
        case PART_FLAG_VERTEX_TRANSFORM:
            return "VERTEX_TRANSFORM";
        case PART_FLAG_SIZE_X:
            return "SIZE_X";
        case PART_FLAG_SIZE_Y:
            return "SIZE_Y";
        case PART_FLAG_U_MOVE:
            return "U_MOVE";
        case PART_FLAG_V_MOVE:
            return "V_MOVE";
        case PART_FLAG_UV_ROTATION:
            return "UV_ROTATION";
        case PART_FLAG_U_SCALE:
            return "U_SCALE";
        case PART_FLAG_V_SCALE:
            return "V_SCALE";
        case PART_FLAG_BOUNDINGRADIUS:
            return "BOUNDINGRADIUS";
        case PART_FLAG_MASK:
            return "MASK";
        case PART_FLAG_PRIORITY:
            return "PRIORITY";
        case PART_FLAG_INSTANCE_KEYFRAME:
            return "INSTANCE_KEYFRAME";
        case PART_FLAG_EFFECT_KEYFRAME:
...
template <typename T>
struct EffectNodeBehaviorTraits {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_NONE;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementBasic> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementBasic;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementRndSeedChange> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementRndSeedChange;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementDelay> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementDelay;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementGravity> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementGravity;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementPosition> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementPosition;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementRotation> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementRotation;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementRotationTrans> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementRotationTrans;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementTransSpeed> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTransSpeed;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementTangentialAcceleration> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTangentialAcceleration;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementInitColor> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementInitColor;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementTransColor> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTransColor;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementAlphaFade> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementAlphaFade;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementSize> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementSize;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleElementTransSize> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTransSize;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticlePointGravity> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticlePointGravity;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleTurnToDirectionEnabled> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleTurnToDirectionEnabled;
};

template <>
struct EffectNodeBehaviorTraits<ss::ssfb::EffectParticleInfiniteEmitEnabled> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleInfiniteEmitEnabled;
};

template <typename T>
struct EffectNodeBehaviorUnionTraits {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_NONE;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementBasic> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementBasic;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementRndSeedChange> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementRndSeedChange;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementDelay> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementDelay;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementGravity> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementGravity;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementPosition> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementPosition;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementRotation> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementRotation;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementRotationTrans> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementRotationTrans;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementTransSpeed> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTransSpeed;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementTangentialAcceleration> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTangentialAcceleration;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementInitColor> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementInitColor;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementTransColor> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTransColor;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementAlphaFade> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementAlphaFade;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementSize> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementSize;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleElementTransSize> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleElementTransSize;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticlePointGravity> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticlePointGravity;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleTurnToDirectionEnabled> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleTurnToDirectionEnabled;
};

template <>
struct EffectNodeBehaviorUnionTraits<ss::ssfb::EffectParticleInfiniteEmitEnabled> {
    static const EffectNodeBehavior enum_value = EffectNodeBehavior_EffectParticleInfiniteEmitEnabled;
};
...
struct EffectNodeBehaviorUnion {
    ...
    EffectNodeBehaviorUnion(EffectNodeBehaviorUnion &&u) FLATBUFFERS_NOEXCEPT : type(EffectNodeBehavior_NONE), value(nullptr) {
    ...
    ss::ssfb::EffectParticleElementBasic *AsEffectParticleElementBasic() {
        return type == EffectNodeBehavior_EffectParticleElementBasic ? reinterpret_cast<ss::ssfb::EffectParticleElementBasic *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementBasic *AsEffectParticleElementBasic() const {
        return type == EffectNodeBehavior_EffectParticleElementBasic ? reinterpret_cast<const ss::ssfb::EffectParticleElementBasic *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementRndSeedChange *AsEffectParticleElementRndSeedChange() {
        return type == EffectNodeBehavior_EffectParticleElementRndSeedChange ? reinterpret_cast<ss::ssfb::EffectParticleElementRndSeedChange *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementRndSeedChange *AsEffectParticleElementRndSeedChange() const {
        return type == EffectNodeBehavior_EffectParticleElementRndSeedChange ? reinterpret_cast<const ss::ssfb::EffectParticleElementRndSeedChange *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementDelay *AsEffectParticleElementDelay() {
        return type == EffectNodeBehavior_EffectParticleElementDelay ? reinterpret_cast<ss::ssfb::EffectParticleElementDelay *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementDelay *AsEffectParticleElementDelay() const {
        return type == EffectNodeBehavior_EffectParticleElementDelay ? reinterpret_cast<const ss::ssfb::EffectParticleElementDelay *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementGravity *AsEffectParticleElementGravity() {
        return type == EffectNodeBehavior_EffectParticleElementGravity ? reinterpret_cast<ss::ssfb::EffectParticleElementGravity *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementGravity *AsEffectParticleElementGravity() const {
        return type == EffectNodeBehavior_EffectParticleElementGravity ? reinterpret_cast<const ss::ssfb::EffectParticleElementGravity *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementPosition *AsEffectParticleElementPosition() {
        return type == EffectNodeBehavior_EffectParticleElementPosition ? reinterpret_cast<ss::ssfb::EffectParticleElementPosition *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementPosition *AsEffectParticleElementPosition() const {
        return type == EffectNodeBehavior_EffectParticleElementPosition ? reinterpret_cast<const ss::ssfb::EffectParticleElementPosition *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementRotation *AsEffectParticleElementRotation() {
        return type == EffectNodeBehavior_EffectParticleElementRotation ? reinterpret_cast<ss::ssfb::EffectParticleElementRotation *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementRotation *AsEffectParticleElementRotation() const {
        return type == EffectNodeBehavior_EffectParticleElementRotation ? reinterpret_cast<const ss::ssfb::EffectParticleElementRotation *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementRotationTrans *AsEffectParticleElementRotationTrans() {
        return type == EffectNodeBehavior_EffectParticleElementRotationTrans ? reinterpret_cast<ss::ssfb::EffectParticleElementRotationTrans *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementRotationTrans *AsEffectParticleElementRotationTrans() const {
        return type == EffectNodeBehavior_EffectParticleElementRotationTrans ? reinterpret_cast<const ss::ssfb::EffectParticleElementRotationTrans *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementTransSpeed *AsEffectParticleElementTransSpeed() {
        return type == EffectNodeBehavior_EffectParticleElementTransSpeed ? reinterpret_cast<ss::ssfb::EffectParticleElementTransSpeed *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementTransSpeed *AsEffectParticleElementTransSpeed() const {
        return type == EffectNodeBehavior_EffectParticleElementTransSpeed ? reinterpret_cast<const ss::ssfb::EffectParticleElementTransSpeed *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementTangentialAcceleration *AsEffectParticleElementTangentialAcceleration() {
        return type == EffectNodeBehavior_EffectParticleElementTangentialAcceleration ? reinterpret_cast<ss::ssfb::EffectParticleElementTangentialAcceleration *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementTangentialAcceleration *AsEffectParticleElementTangentialAcceleration() const {
        return type == EffectNodeBehavior_EffectParticleElementTangentialAcceleration ? reinterpret_cast<const ss::ssfb::EffectParticleElementTangentialAcceleration *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementInitColor *AsEffectParticleElementInitColor() {
        return type == EffectNodeBehavior_EffectParticleElementInitColor ? reinterpret_cast<ss::ssfb::EffectParticleElementInitColor *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementInitColor *AsEffectParticleElementInitColor() const {
        return type == EffectNodeBehavior_EffectParticleElementInitColor ? reinterpret_cast<const ss::ssfb::EffectParticleElementInitColor *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementTransColor *AsEffectParticleElementTransColor() {
        return type == EffectNodeBehavior_EffectParticleElementTransColor ? reinterpret_cast<ss::ssfb::EffectParticleElementTransColor *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementTransColor *AsEffectParticleElementTransColor() const {
        return type == EffectNodeBehavior_EffectParticleElementTransColor ? reinterpret_cast<const ss::ssfb::EffectParticleElementTransColor *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementAlphaFade *AsEffectParticleElementAlphaFade() {
        return type == EffectNodeBehavior_EffectParticleElementAlphaFade ? reinterpret_cast<ss::ssfb::EffectParticleElementAlphaFade *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementAlphaFade *AsEffectParticleElementAlphaFade() const {
        return type == EffectNodeBehavior_EffectParticleElementAlphaFade ? reinterpret_cast<const ss::ssfb::EffectParticleElementAlphaFade *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementSize *AsEffectParticleElementSize() {
        return type == EffectNodeBehavior_EffectParticleElementSize ? reinterpret_cast<ss::ssfb::EffectParticleElementSize *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementSize *AsEffectParticleElementSize() const {
        return type == EffectNodeBehavior_EffectParticleElementSize ? reinterpret_cast<const ss::ssfb::EffectParticleElementSize *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleElementTransSize *AsEffectParticleElementTransSize() {
        return type == EffectNodeBehavior_EffectParticleElementTransSize ? reinterpret_cast<ss::ssfb::EffectParticleElementTransSize *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleElementTransSize *AsEffectParticleElementTransSize() const {
        return type == EffectNodeBehavior_EffectParticleElementTransSize ? reinterpret_cast<const ss::ssfb::EffectParticleElementTransSize *>(value) : nullptr;
    }
    ss::ssfb::EffectParticlePointGravity *AsEffectParticlePointGravity() {
        return type == EffectNodeBehavior_EffectParticlePointGravity ? reinterpret_cast<ss::ssfb::EffectParticlePointGravity *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticlePointGravity *AsEffectParticlePointGravity() const {
        return type == EffectNodeBehavior_EffectParticlePointGravity ? reinterpret_cast<const ss::ssfb::EffectParticlePointGravity *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleTurnToDirectionEnabled *AsEffectParticleTurnToDirectionEnabled() {
        return type == EffectNodeBehavior_EffectParticleTurnToDirectionEnabled ? reinterpret_cast<ss::ssfb::EffectParticleTurnToDirectionEnabled *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleTurnToDirectionEnabled *AsEffectParticleTurnToDirectionEnabled() const {
        return type == EffectNodeBehavior_EffectParticleTurnToDirectionEnabled ? reinterpret_cast<const ss::ssfb::EffectParticleTurnToDirectionEnabled *>(value) : nullptr;
    }
    ss::ssfb::EffectParticleInfiniteEmitEnabled *AsEffectParticleInfiniteEmitEnabled() {
        return type == EffectNodeBehavior_EffectParticleInfiniteEmitEnabled ? reinterpret_cast<ss::ssfb::EffectParticleInfiniteEmitEnabled *>(value) : nullptr;
    }
    const ss::ssfb::EffectParticleInfiniteEmitEnabled *AsEffectParticleInfiniteEmitEnabled() const {
        return type == EffectNodeBehavior_EffectParticleInfiniteEmitEnabled ? reinterpret_cast<const ss::ssfb::EffectParticleInfiniteEmitEnabled *>(value) : nullptr;
    }
};
...
template <typename T>
struct userDataValueTraits {
    static const userDataValue enum_value = userDataValue_NONE;
};

template <>
struct userDataValueTraits<ss::ssfb::userDataInteger> {
    static const userDataValue enum_value = userDataValue_userDataInteger;
};

template <>
struct userDataValueTraits<ss::ssfb::userDataRect> {
    static const userDataValue enum_value = userDataValue_userDataRect;
};

template <>
struct userDataValueTraits<ss::ssfb::userDataPoint> {
    static const userDataValue enum_value = userDataValue_userDataPoint;
};

template <>
struct userDataValueTraits<ss::ssfb::userDataString> {
    static const userDataValue enum_value = userDataValue_userDataString;
};

template <typename T>
struct userDataValueUnionTraits {
    static const userDataValue enum_value = userDataValue_NONE;
};

template <>
struct userDataValueUnionTraits<ss::ssfb::userDataInteger> {
    static const userDataValue enum_value = userDataValue_userDataInteger;
};

template <>
struct userDataValueUnionTraits<ss::ssfb::userDataRect> {
    static const userDataValue enum_value = userDataValue_userDataRect;
};

template <>
struct userDataValueUnionTraits<ss::ssfb::userDataPoint> {
    static const userDataValue enum_value = userDataValue_userDataPoint;
};

template <>
struct userDataValueUnionTraits<ss::ssfb::userDataStringT> {
    static const userDataValue enum_value = userDataValue_userDataString;
};
...
struct userDataValueUnion {
    ...
    userDataValueUnion(userDataValueUnion &&u) FLATBUFFERS_NOEXCEPT : type(userDataValue_NONE), value(nullptr) {
        std::swap(type, u.type);
        std::swap(value, u.value);
    }
    userDataValueUnion(const userDataValueUnion &);
    userDataValueUnion &operator=(const userDataValueUnion &u) {
        userDataValueUnion t(u);
        std::swap(type, t.type);
        std::swap(value, t.value);
        return *this;
    }
    ...
    ss::ssfb::userDataInteger *AsuserDataInteger() {
        return type == userDataValue_userDataInteger ? reinterpret_cast<ss::ssfb::userDataInteger *>(value) : nullptr;
    }
    const ss::ssfb::userDataInteger *AsuserDataInteger() const {
        return type == userDataValue_userDataInteger ? reinterpret_cast<const ss::ssfb::userDataInteger *>(value) : nullptr;
    }
    ss::ssfb::userDataRect *AsuserDataRect() {
        return type == userDataValue_userDataRect ? reinterpret_cast<ss::ssfb::userDataRect *>(value) : nullptr;
    }
    const ss::ssfb::userDataRect *AsuserDataRect() const {
        return type == userDataValue_userDataRect ? reinterpret_cast<const ss::ssfb::userDataRect *>(value) : nullptr;
    }
    ss::ssfb::userDataPoint *AsuserDataPoint() {
        return type == userDataValue_userDataPoint ? reinterpret_cast<ss::ssfb::userDataPoint *>(value) : nullptr;
    }
    const ss::ssfb::userDataPoint *AsuserDataPoint() const {
        return type == userDataValue_userDataPoint ? reinterpret_cast<const ss::ssfb::userDataPoint *>(value) : nullptr;
    }
    ss::ssfb::userDataStringT *AsuserDataString() {
        return type == userDataValue_userDataString ? reinterpret_cast<ss::ssfb::userDataStringT *>(value) : nullptr;
    }
    const ss::ssfb::userDataStringT *AsuserDataString() const {
        return type == userDataValue_userDataString ? reinterpret_cast<const ss::ssfb::userDataStringT *>(value) : nullptr;
    }
};
...
EffectParticleInfiniteEmitEnabled FLATBUFFERS_FINAL_CLASS {
   private:
    int32_t flag_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleTurnToDirectionEnabled FLATBUFFERS_FINAL_CLASS {
   private:
    float Rotation_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticlePointGravity FLATBUFFERS_FINAL_CLASS {
   private:
    float Position_x_;
    float Position_y_;
    float Power_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementTransSize FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementTransSize &lhs, const EffectParticleElementTransSize &rhs) {
    return (lhs.SizeXMinValue() == rhs.SizeXMinValue()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementSize FLATBUFFERS_FINAL_CLASS {
   private:
    float SizeXMinValue_;
    float SizeXMaxValue_;
    float SizeYMinValue_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementAlphaFade FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementAlphaFade &lhs, const EffectParticleElementAlphaFade &rhs) {
    return (lhs.disprangeMinValue() == rhs.disprangeMinValue()) &&
...
inline bool operator==(const EffectParticleElementTransColor &lhs, const EffectParticleElementTransColor &rhs) {
    return (lhs.ColorMinValue() == rhs.ColorMinValue()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementInitColor FLATBUFFERS_FINAL_CLASS {
   private:
    uint32_t ColorMinValue_;
    uint32_t ColorMaxValue_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementTangentialAcceleration FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementTangentialAcceleration &lhs, const EffectParticleElementTangentialAcceleration &rhs) {
    return (lhs.AccelerationMinValue() == rhs.AccelerationMinValue()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementTransSpeed FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementTransSpeed &lhs, const EffectParticleElementTransSpeed &rhs) {
    return (lhs.SpeedMinValue() == rhs.SpeedMinValue()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementRotationTrans FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementRotationTrans &lhs, const EffectParticleElementRotationTrans &rhs) {
    return (lhs.RotationFactor() == rhs.RotationFactor()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementRotation FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementRotation &lhs, const EffectParticleElementRotation &rhs) {
    return (lhs.RotationMinValue() == rhs.RotationMinValue()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementPosition FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementPosition &lhs, const EffectParticleElementPosition &rhs) {
    return (lhs.OffsetXMinValue() == rhs.OffsetXMinValue()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementGravity FLATBUFFERS_FINAL_CLASS {
   private:
    float Gravity_x_;
    float Gravity_y_;
...
inline bool operator==(const EffectParticleElementGravity &lhs, const EffectParticleElementGravity &rhs) {
    return (lhs.Gravity_x() == rhs.Gravity_x()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementDelay FLATBUFFERS_FINAL_CLASS {
   private:
    int32_t DelayTime_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementRndSeedChange FLATBUFFERS_FINAL_CLASS {
   private:
    int32_t Seed_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
EffectParticleElementBasic FLATBUFFERS_FINAL_CLASS {
   private:
...
inline bool operator==(const EffectParticleElementBasic &lhs, const EffectParticleElementBasic &rhs) {
    return (lhs.SsEffectFunctionType() == rhs.SsEffectFunctionType()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
userDataInteger FLATBUFFERS_FINAL_CLASS {
   private:
    int32_t integer_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
userDataRect FLATBUFFERS_FINAL_CLASS {
   private:
    int32_t x_;
    int32_t y_;
    int32_t w_;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4)
userDataPoint FLATBUFFERS_FINAL_CLASS {
   private:
    int32_t x_;
    int32_t y_;
...
inline void EffectNode::UnPackTo(EffectNodeT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    {
        auto _e = Behavior_type();
        if (_e) {
            _o->Behavior.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                _o->Behavior[_i].type = static_cast<ss::ssfb::EffectNodeBehavior>(_e->Get(_i));
            }
        } else {
            _o->Behavior.resize(0);
        }
    }
    {
        auto _e = Behavior();
        if (_e) {
            _o->Behavior.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                _o->Behavior[_i].value = ss::ssfb::EffectNodeBehaviorUnion::UnPack(_e->Get(_i), Behavior_type()->GetEnum<EffectNodeBehavior>(_i), _resolver);
            }
        } else {
            _o->Behavior.resize(0);
        }
...
inline EffectFileT::EffectFileT(const EffectFileT &o)
    ...
    for (const auto &effectNode_ : o.effectNode) {
        effectNode.emplace_back((effectNode_) ? new ss::ssfb::EffectNodeT(*effectNode_) : nullptr);
    }
}
...
inline void EffectFile::UnPackTo(EffectFileT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    {
        auto _e = isLockRandSeed();
        _o->isLockRandSeed = _e;
    }
    {
        auto _e = lockRandSeed();
        _o->lockRandSeed = _e;
    }
    {
        auto _e = layoutScaleX();
        _o->layoutScaleX = _e;
    }
    {
        auto _e = layoutScaleY();
        _o->layoutScaleY = _e;
    }
    {
        auto _e = numNodeList();
    ...
    }
    {
        auto _e = effectNode();
        if (_e) {
            _o->effectNode.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->effectNode[_i]) {
                    _e->Get(_i)->UnPackTo(_o->effectNode[_i].get(), _resolver);
                } else {
                    _o->effectNode[_i] = std::unique_ptr<ss::ssfb::EffectNodeT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->effectNode.resize(0);
        }
    }
}
...
inline void Cell::UnPackTo(CellT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    }
    {
        ...
        if (_e) {
            if (_o->cellMap) {
                _e->UnPackTo(_o->cellMap.get(), _resolver);
            } else {
                _o->cellMap = std::unique_ptr<ss::ssfb::CellMapT>(_e->UnPack(_resolver));
            }
        } else if (_o->cellMap) {
            _o->cellMap.reset();
        }
    ...
    {
        auto _e = indexInCellMap();
        _o->indexInCellMap = _e;
    }
    {
        auto _e = x();
        _o->x = _e;
...
inline bool operator==(const frameDataIndexT &lhs, const frameDataIndexT &rhs) {
    return (lhs.states.size() == rhs.states.size() && std::equal(lhs.states.cbegin(), lhs.states.cend(), rhs.states.cbegin(), [](std::unique_ptr<ss::ssfb::partStateT> const &a, std::unique_ptr<ss::ssfb::partStateT> const &b) { return (a == b) || (a && b && *a == *b); }));
}
...
inline frameDataIndexT::frameDataIndexT(const frameDataIndexT &o) {
    ...
    for (const auto &states_ : o.states) {
        states.emplace_back((states_) ? new ss::ssfb::partStateT(*states_) : nullptr);
    }
}
...
inline void frameDataIndex::UnPackTo(frameDataIndexT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    (void)_resolver;
    {
        auto _e = states();
        if (_e) {
            _o->states.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->states[_i]) {
                    _e->Get(_i)->UnPackTo(_o->states[_i].get(), _resolver);
                } else {
                    _o->states[_i] = std::unique_ptr<ss::ssfb::partStateT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->states.resize(0);
...
inline void userDataItem::UnPackTo(userDataItemT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    }
    {
        ...
        if (_e) {
            _o->data.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                _o->data[_i].type = static_cast<ss::ssfb::userDataValue>(_e->Get(_i));
            }
        } else {
            _o->data.resize(0);
        }
    }
    {
        ...
        if (_e) {
            _o->data.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                _o->data[_i].value = ss::ssfb::userDataValueUnion::UnPack(_e->Get(_i), data_type()->GetEnum<userDataValue>(_i), _resolver);
            }
        } else {
            _o->data.resize(0);
        }
...
inline userDataPerFrameT::userDataPerFrameT(const userDataPerFrameT &o)
    ...
    for (const auto &data_ : o.data) {
        data.emplace_back((data_) ? new ss::ssfb::userDataItemT(*data_) : nullptr);
    }
}
...
inline void userDataPerFrame::UnPackTo(userDataPerFrameT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    }
    {
        ...
        if (_e) {
            ...
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->data[_i]) {
                    _e->Get(_i)->UnPackTo(_o->data[_i].get(), _resolver);
                } else {
                    _o->data[_i] = std::unique_ptr<ss::ssfb::userDataItemT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->data.resize(0);
...
inline AnimationDataT::AnimationDataT(const AnimationDataT &o)
    ...
    for (const auto &defaultData_ : o.defaultData) {
        defaultData.emplace_back((defaultData_) ? new ss::ssfb::AnimationInitialDataT(*defaultData_) : nullptr);
    }
    frameData.reserve(o.frameData.size());
    for (const auto &frameData_ : o.frameData) {
        frameData.emplace_back((frameData_) ? new ss::ssfb::frameDataIndexT(*frameData_) : nullptr);
    }
    userData.reserve(o.userData.size());
    for (const auto &userData_ : o.userData) {
        userData.emplace_back((userData_) ? new ss::ssfb::userDataPerFrameT(*userData_) : nullptr);
    }
    labelData.reserve(o.labelData.size());
    for (const auto &labelData_ : o.labelData) {
        labelData.emplace_back((labelData_) ? new ss::ssfb::labelDataItemT(*labelData_) : nullptr);
    }
    meshsDataUV.reserve(o.meshsDataUV.size());
    for (const auto &meshsDataUV_ : o.meshsDataUV) {
        meshsDataUV.emplace_back((meshsDataUV_) ? new ss::ssfb::meshDataUVT(*meshsDataUV_) : nullptr);
    }
    meshsDataIndices.reserve(o.meshsDataIndices.size());
    for (const auto &meshsDataIndices_ : o.meshsDataIndices) {
        meshsDataIndices.emplace_back((meshsDataIndices_) ? new ss::ssfb::meshDataIndicesT(*meshsDataIndices_) : nullptr);
    }
}
...
inline void AnimationData::UnPackTo(AnimationDataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    }
    {
        auto _e = defaultData();
        if (_e) {
            _o->defaultData.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->defaultData[_i]) {
                    _e->Get(_i)->UnPackTo(_o->defaultData[_i].get(), _resolver);
                } else {
                    _o->defaultData[_i] = std::unique_ptr<ss::ssfb::AnimationInitialDataT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->defaultData.resize(0);
        }
    }
    {
        auto _e = frameData();
        if (_e) {
            _o->frameData.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->frameData[_i]) {
                    _e->Get(_i)->UnPackTo(_o->frameData[_i].get(), _resolver);
                } else {
                    _o->frameData[_i] = std::unique_ptr<ss::ssfb::frameDataIndexT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->frameData.resize(0);
        }
    }
    {
        auto _e = userData();
        if (_e) {
            _o->userData.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->userData[_i]) {
                    _e->Get(_i)->UnPackTo(_o->userData[_i].get(), _resolver);
                } else {
                    _o->userData[_i] = std::unique_ptr<ss::ssfb::userDataPerFrameT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->userData.resize(0);
        }
    }
    {
        auto _e = labelData();
        if (_e) {
            _o->labelData.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->labelData[_i]) {
                    _e->Get(_i)->UnPackTo(_o->labelData[_i].get(), _resolver);
                } else {
                    _o->labelData[_i] = std::unique_ptr<ss::ssfb::labelDataItemT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->labelData.resize(0);
        }
    }
    {
        auto _e = meshsDataUV();
        if (_e) {
            _o->meshsDataUV.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->meshsDataUV[_i]) {
                    _e->Get(_i)->UnPackTo(_o->meshsDataUV[_i].get(), _resolver);
                } else {
                    _o->meshsDataUV[_i] = std::unique_ptr<ss::ssfb::meshDataUVT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->meshsDataUV.resize(0);
        }
    }
    {
        auto _e = meshsDataIndices();
        if (_e) {
            _o->meshsDataIndices.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->meshsDataIndices[_i]) {
                    _e->Get(_i)->UnPackTo(_o->meshsDataIndices[_i].get(), _resolver);
                } else {
                    _o->meshsDataIndices[_i] = std::unique_ptr<ss::ssfb::meshDataIndicesT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->meshsDataIndices.resize(0);
        }
    }
    {
        auto _e = startFrames();
...
inline void AnimationInitialData::UnPackTo(AnimationInitialDataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    {
        auto _e = boundingRadius();
        _o->boundingRadius = _e;
    }
    {
        auto _e = instanceValue_curKeyframe();
        _o->instanceValue_curKeyframe = _e;
    }
    {
        auto _e = instanceValue_startFrame();
        _o->instanceValue_startFrame = _e;
    }
    {
        auto _e = instanceValue_endFrame();
        _o->instanceValue_endFrame = _e;
    }
    {
        auto _e = instanceValue_loopNum();
        _o->instanceValue_loopNum = _e;
    }
    {
        auto _e = instanceValue_speed();
        _o->instanceValue_speed = _e;
    }
    {
        auto _e = instanceValue_loopflag();
        _o->instanceValue_loopflag = _e;
    }
    {
        auto _e = effectValue_curKeyframe();
        _o->effectValue_curKeyframe = _e;
    }
    {
        auto _e = effectValue_startTime();
        _o->effectValue_startTime = _e;
    }
    {
        auto _e = effectValue_speed();
        _o->effectValue_speed = _e;
    }
    {
        auto _e = effectValue_loopflag();
        _o->effectValue_loopflag = _e;
    }
}
...
inline ::flatbuffers::Offset<AnimationInitialData> CreateAnimationInitialData(::flatbuffers::FlatBufferBuilder &_fbb, const AnimationInitialDataT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
    ...
    struct _VectorArgs {
        ::flatbuffers::FlatBufferBuilder *__fbb;
        const AnimationInitialDataT *__o;
        const ::flatbuffers::rehasher_function_t *__rehasher;
    } _va = {&_fbb, _o, _rehasher};
    (void)_va;
    auto _index = _o->index;
...
inline void PartData::UnPackTo(PartDataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    {
        auto _e = alphaBlendType();
        _o->alphaBlendType = _e;
    }
    {
        auto _e = refname();
        if (_e) _o->refname = _e->str();
    }
    {
        auto _e = effectfilename();
        if (_e) _o->effectfilename = _e->str();
    }
    {
        auto _e = colorLabel();
        if (_e) _o->colorLabel = _e->str();
    }
    {
        auto _e = maskInfluence();
        _o->maskInfluence = _e;
    }
}
...
inline AnimePackDataT::AnimePackDataT(const AnimePackDataT &o)
    ...
    for (const auto &parts_ : o.parts) {
        parts.emplace_back((parts_) ? new ss::ssfb::PartDataT(*parts_) : nullptr);
    }
    animations.reserve(o.animations.size());
    for (const auto &animations_ : o.animations) {
        animations.emplace_back((animations_) ? new ss::ssfb::AnimationDataT(*animations_) : nullptr);
    }
}
...
inline void AnimePackData::UnPackTo(AnimePackDataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    }
    {
        auto _e = parts();
        if (_e) {
            _o->parts.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->parts[_i]) {
                    _e->Get(_i)->UnPackTo(_o->parts[_i].get(), _resolver);
                } else {
                    _o->parts[_i] = std::unique_ptr<ss::ssfb::PartDataT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->parts.resize(0);
    ...
    }
    {
        ...
        if (_e) {
            ...
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->animations[_i]) {
                    _e->Get(_i)->UnPackTo(_o->animations[_i].get(), _resolver);
                } else {
                    _o->animations[_i] = std::unique_ptr<ss::ssfb::AnimationDataT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->animations.resize(0);
        }
    }
}
...
inline ProjectDataT::ProjectDataT(const ProjectDataT &o)
    ...
    for (const auto &cells_ : o.cells) {
        cells.emplace_back((cells_) ? new ss::ssfb::CellT(*cells_) : nullptr);
    }
    animePacks.reserve(o.animePacks.size());
    for (const auto &animePacks_ : o.animePacks) {
        animePacks.emplace_back((animePacks_) ? new ss::ssfb::AnimePackDataT(*animePacks_) : nullptr);
    }
    effectFileList.reserve(o.effectFileList.size());
    for (const auto &effectFileList_ : o.effectFileList) {
        effectFileList.emplace_back((effectFileList_) ? new ss::ssfb::EffectFileT(*effectFileList_) : nullptr);
    }
}
...
inline void ProjectData::UnPackTo(ProjectDataT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
    ...
    {
        auto _e = imageBaseDir();
        if (_e) _o->imageBaseDir = _e->str();
    }
    {
        auto _e = cells();
        if (_e) {
            _o->cells.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->cells[_i]) {
                    _e->Get(_i)->UnPackTo(_o->cells[_i].get(), _resolver);
                } else {
                    _o->cells[_i] = std::unique_ptr<ss::ssfb::CellT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->cells.resize(0);
    ...
    }
    {
        auto _e = animePacks();
        if (_e) {
            _o->animePacks.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->animePacks[_i]) {
                    _e->Get(_i)->UnPackTo(_o->animePacks[_i].get(), _resolver);
                } else {
                    _o->animePacks[_i] = std::unique_ptr<ss::ssfb::AnimePackDataT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->animePacks.resize(0);
        }
    }
    {
        auto _e = effectFileList();
        if (_e) {
            _o->effectFileList.resize(_e->size());
            for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
                if (_o->effectFileList[_i]) {
                    _e->Get(_i)->UnPackTo(_o->effectFileList[_i].get(), _resolver);
                } else {
                    _o->effectFileList[_i] = std::unique_ptr<ss::ssfb::EffectFileT>(_e->Get(_i)->UnPack(_resolver));
                };
            }
        } else {
            _o->effectFileList.resize(0);
        }
    }
    {
        auto _e = numCells();
    ...
    {
        auto _e = numAnimePacks();
        _o->numAnimePacks = _e;
    }
    {
        auto _e = numEffectFileList();
        _o->numEffectFileList = _e;
    }
}

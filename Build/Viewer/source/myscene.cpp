...
//    TwAddVarRW(g_twbar, "particle draw", TW_TYPE_INT32, &g_particle_draw_num, " min='0' ");
	...
	TwAddVarRW(g_twbar, "Totalframe", TW_TYPE_INT32, &m_InfoAnimeTotalFrame, " group='Anime Info' ");

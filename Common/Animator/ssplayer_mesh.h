...
class SsMeshPart {
   ...
   public:
    SsMeshPart() : isBind(false), targetCell(0), bindBoneInfo(), weightColors(), vertices_outer(), draw_vertices(), myPartState(0), vertices(), colors(), uvs(), indices(), update_vertices_outer(), offset_world_vertices() {
    }

    SsMeshPart(SsPartState* s) : isBind(false), targetCell(0), weightColors(), bindBoneInfo(), vertices_outer(), draw_vertices(), vertices(), colors(), uvs(), indices(), update_vertices_outer(), offset_world_vertices() {
        myPartState = s;
    }

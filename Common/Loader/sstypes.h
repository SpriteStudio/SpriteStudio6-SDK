...
/// rgba 小数版
template <>
inline SsTColor<float>::SsTColor() : r(0.5f), g(0.5f), b(0.5f), a(1.f) {}
template <>
inline void SsTColor<float>::fromARGB(u32 c) {
    a = (float)(c >> 24) / 255.f;
...
template <>
inline void SsTColor<float>::fromBGRA(u32 c) {
    b = (float)(c >> 24) / 255.f;
...
template <>
inline u32 SsTColor<float>::toARGB() const {
    u32 c = (u8)(a * 255) << 24 | (u8)(r * 255) << 16 | (u8)(g * 255) << 8 | (u8)(b * 255);
    return c;
}

template <>
inline SsTColor<u32>::SsTColor() : r(255), g(255), b(255), a(255) {}
template <>
inline void SsTColor<u32>::fromARGB(u32 c) {
    a = (c >> 24);
    r = ((c >> 16) & 0xff);
    g = ((c >> 8) & 0xff);
    b = (c & 0xff);
...
template <>
inline void SsTColor<u32>::fromBGRA(u32 c) {
    b = (c >> 24);
    g = ((c >> 16) & 0xff);
    r = ((c >> 8) & 0xff);
    a = (c & 0xff);
...
template <>
inline u32 SsTColor<u32>::toARGB() const {
    u32 c = (u8)(a) << 24 | (u8)(r) << 16 | (u8)(g) << 8 | (u8)(b);
    return c;
}

template <>
inline SsTColor<u8>::SsTColor() : r(255), g(255), b(255), a(255) {}
template <>
inline void SsTColor<u8>::fromARGB(u32 c) {
    a = (c >> 24);
    r = ((c >> 16) & 0xff);
    g = ((c >> 8) & 0xff);
    b = (c & 0xff);
...
template <>
inline void SsTColor<u8>::fromBGRA(u32 c) {
    b = (c >> 24);
    g = ((c >> 16) & 0xff);
    r = ((c >> 8) & 0xff);
    a = (c & 0xff);
...
template <>
inline u32 SsTColor<u8>::toARGB() const {
    u32 c = (u8)(a) << 24 | (u8)(r) << 16 | (u8)(g) << 8 | (u8)(b);
    return c;
}
...
struct SsPartsColorAnime {
    ...
    SsPartsColorAnime() : target(SsColorBlendTarget::invalid),
...
struct SsColorAnime {
    ...
    int getTargetToInt() { return (int)target; }
    int getBlendTypeToInt() { return (int)blendType; }
    SsColorAnime() : target(SsColorBlendTarget::invalid),
                     blendType(SsBlendType::invalid) {}
};
...
class SsUserDataAnime {
   public:
    ...
    SsUserDataAnime() : useInteger(false),
                        usePoint(false),
                        useRect(false),
                        useString(false) {}
};
...
class SsSignalParam {
   public:
    ...
    SsSignalParam()
        : paramId(""), type(SsSignalParamType::none) {
        value.i = 0;
    }
};
...
class SsDeformAttr {
   public:
    ...
    bool operator==(int n) const {
        SPRITESTUDIO6SDK_NOUSE_ARGUMENT(n);
        return false;
    }
    bool operator!=(int n) const {
        SPRITESTUDIO6SDK_NOUSE_ARGUMENT(n);

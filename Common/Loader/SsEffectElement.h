...
class VarianceValue : public SsXmlRangeValueConverter {
   ...
   public:
    ...
    VarianceValue& operator=(mytype v) {
        value = v;
        return *this;
    }
...
template <>
inline bool VarianceValue<float>::inputString(SsString _value, SsString _subvalue) {
...
template <>
inline bool VarianceValue<int>::inputString(SsString _value, SsString _subvalue) {
...
template <>
inline bool VarianceValue<SsU8Color>::inputString(SsString _value, SsString _subvalue) {

...
class SsValue {
   ...
   public:
    ...
    explicit SsValue(SsString& str) {
        type = string_type;
        _str = new SsString(str);
    }
    explicit SsValue(const char* str) {
        type = string_type;
        _str = new SsString(str);
    }
...
template <>
inline const SsString& SsValue::get<SsString>() const {
    static SsString ret = "";
...
template <>
inline const int& SsValue::get<int>() const {
    if (this->type == float_type) {
        return _int_temp;
    } else {
        return _int;
...
template <>
inline const float& SsValue::get<float>() const {
    if (this->type == float_type) {
        return _float;
    } else {
        return _float_temp;
...
template <>
inline const bool& SsValue::get<bool>() const {
...
template <>
inline const SsArray& SsValue::get<SsArray>() const {
    return *_array;
}
template <>
...
template <>
inline const SsHash& SsValue::get<SsHash>() const {
    return *_hash;
}
template <>
...
template <>
inline bool SsValue::is<bool>() const {
    return type == boolean_type;
}

template <>
inline bool SsValue::is<int>() const {
    return type == int_type;
}

template <>
inline bool SsValue::is<float>() const {
    return type == float_type;
}
template <>
inline bool SsValue::is<SsString>() const {
    return type == string_type;
}

template <>
inline bool SsValue::is<SsArray>() const {
    return type == array_type;
}

template <>
inline bool SsValue::is<SsHash>() const {
